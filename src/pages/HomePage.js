              ...
              <section className="container-fluid bg-blue">
                <div className="row">
                  <div className="col-12 text-center">
                    <h1 className="h2 text-white pa-30 mx-auto hp-hero-text">Ґвара - це спілка людей, які пишуть та діляться своїми творами з іншими.</h1>
                    <button type="button" className="btn mb-30"><span>Зареєструватись</span></button>
                  </div>
                </div>
              </section>
